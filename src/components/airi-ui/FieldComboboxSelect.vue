...
<template>
  <label class="flex flex-col gap-4">
    ...
    >
      ...
      >
        <div class="flex items-center gap-1 break-words text-left text-sm font-medium">
          <slot name="label">
            {{ props.label }}
          </slot>
        </div>
        <div class="break-words text-left text-xs text-neutral-500 dark:text-neutral-400">
